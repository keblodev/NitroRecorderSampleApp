  ...
  render() {
    ...
    return (
      <section className='main'>
        ...
        <select data-ft="select" name="select" defaultValue="value1">
          <option data-ft="select-value1" value="value1">Value 1</option>
          <option data-ft="select-value2" value="value2">Value 2</option>
          <option data-ft="select-value3" value="value3">Value 3</option>
        </select>
